...
public class ConsoleReader {
    ...
    public static void readerStart() throws IOException {
        ...
        System.out.println("Введите выражение в формате 8-7 или III*V");
        System.err.println("Число не должно превышать диапазон 0-10 и I-X !");

        String expression = reader.readLine();
        if (calculator.CheckReadingStringFor.rightCharacters(expression)) {
            String[] numbers = expression.split("[\s+-/*]");
